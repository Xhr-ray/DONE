...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="Mnist", choices=["Mnist", "Linear_synthetic", "Fashion_Mnist", "Cifar10" ,"human_activity", "Nist"])
    ...
    parser.add_argument("--algorithm", type=str, default="DONE",choices=["DONE", "GD", "DANE", "Newton", "GT", "PGT", "FEDL","GIANT"])
